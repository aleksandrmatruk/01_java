 ...
 * 4. Метод convertCelsiusToFahrenheit должен правильно переводить градусы Цельсия в градусы Фаренгейта
 * и возвращать это число.
 * 5. Название метода 'convertCelsiusToFahrenheit' менять нельзя.
 */
